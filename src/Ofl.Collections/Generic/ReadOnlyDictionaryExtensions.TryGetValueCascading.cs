...
namespace Ofl.Collections.Generic
{
    public static partial class ReadOnlyDictionaryExtensions
    {
        ...
        public static TValue? TryGetValueCascading<TKey, TValue>(this IReadOnlyDictionary<TKey, TValue> dictionary,
            TKey key, IEnumerable<IReadOnlyDictionary<TKey, TValue>> fallbacks)
            where TValue : struct
        {
            // Validate parameters.
        ...
        public static TValue? TryGetValueCascading<TKey, TValue>(this IReadOnlyDictionary<TKey, TValue> dictionary,
            ...
            where TValue : struct => dictionary.TryGetValueCascading(key, (IEnumerable<IReadOnlyDictionary<TKey, TValue>>) fallbacks);

        public static bool TryGetValueCascading<TKey, TValue>(this IReadOnlyDictionary<TKey, TValue> dictionary,
            TKey key, out TValue value, IEnumerable<IReadOnlyDictionary<TKey, TValue>> fallbacks)
        {
            // Validate parameters.
            if (dictionary == null) throw new ArgumentNullException(nameof(dictionary));
            if (fallbacks == null) throw new ArgumentNullException(nameof(fallbacks));
        ...
        public static bool TryGetValueCascading<TKey, TValue>(this IReadOnlyDictionary<TKey, TValue> dictionary,
            TKey key, out TValue value, params IReadOnlyDictionary<TKey, TValue>[] fallbacks) =>
                dictionary.TryGetValueCascading(key, out value, (IEnumerable<IReadOnlyDictionary<TKey, TValue>>) fallbacks);
    }
}
